  ...
  const fetchTopSellingProducts = async () => {
    try {
      ...
      if (selectedInterval === "Yearly") {
        ...
        apiUrl = `https://www.celltone.iskconbmv.org:8444/SalesAnalysisSystem-0.0.1-SNAPSHOT/api/v1/invoices/least-selling-products?interval=monthly&year=${apiYear}&month=${apiMonth.toLowerCase()}`;
