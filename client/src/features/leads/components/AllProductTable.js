    ...
    useEffect(() => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`https://www.celltone.iskconbmv.org:8444/SalesAnalysisSystem-0.0.1-SNAPSHOT/api/v1/products/update-product/${selectedId}`, formData,
            // {
            //     headers: {
      ...
      const handleCheckboxChange = (e, id) => {
        ...
        if (isChecked) {
          setSelectedId(id);
          const foundProducts = data.find((product) => parseInt(product.id) === parseInt(id));
...
{selectedId && (
        <dialog id='update_modal' className='modal'>
             <div className="modal-box w-11/12 max-w-7xl">
              ...
              <div>
                <label htmlFor="price" className="label label-text text-base">Price Per Unit:</label>
                <input
                  type="number"
