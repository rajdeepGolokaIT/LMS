...
const Least5Distributors = () => {
    ...
    const fetchTopSellingProducts = async () => {
      try {
        ...
        if (selectedInterval === "Yearly") {
          apiUrl = `${BASE_URL}/api/v1/invoice/top-distributors?interval=annually&${locationType}=${locationValue}&year=${selectedYear}&type=least`;
          console.log(apiUrl);
          ...
          apiUrl = `${BASE_URL}/api/v1/invoice/top-distributors?interval=monthly&${locationType}=${locationValue}&year=${apiYear}&month=${apiMonth.toLowerCase()}&type=least`;
          console.log(apiUrl);
          ...
          apiUrl = `${BASE_URL}/api/v1/invoice/top-distributors?interval=${intervalParam}&${locationType}=${locationValue}&customFromDate=${fromDate}&customToDate=${toDate}&type=least`;
          console.log(apiUrl);
  ...
  //   };
    ...
    const downloadPDF = () => {
      ...
      const title = "Least 5 Distributors";
      const fontSize = 14;
      const textWidth =
      ...
      pdf.save("Least 5 Distributors.pdf");
    };
