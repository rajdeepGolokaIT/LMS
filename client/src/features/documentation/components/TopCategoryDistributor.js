    ...
    const fetchTopSellingProducts = async () => {
      try {
        ...
        if (selectedInterval === "Yearly") {
          apiUrl = `https://www.celltone.iskconbmv.org:8444/SalesAnalysisSystem-0.0.1-SNAPSHOT/api/v1/invoice/top-distributors-by-categories?${locationType}=${locationValue}&year=${selectedYear}&interval=annually`;
          console.log(apiUrl);
          ...
          apiUrl = `https://www.celltone.iskconbmv.org:8444/SalesAnalysisSystem-0.0.1-SNAPSHOT/api/v1/invoice/top-distributors-by-categories?${locationType}=${locationValue}&year=${selectedYear}&month=${monthParam}&interval=monthly`;
          console.log(apiUrl);
          ...
          apiUrl = `https://www.celltone.iskconbmv.org:8444/SalesAnalysisSystem-0.0.1-SNAPSHOT/api/v1/invoice/top-distributors-by-categories?${locationType}=${locationValue}&customFromDate=${fromDate}&customToDate=${toDate}&interval=${intervalParam}`;
          console.log(apiUrl);
...
export default TopCategoryDistributor