    ...
    const fetchTopSellingProducts = async () => {
      try {
        ...
        if (selectedInterval === "Yearly") {
          ...
          apiUrl = `https://www.celltone.iskconbmv.org:8444/SalesAnalysisSystem-0.0.1-SNAPSHOT/api/v1/invoice/top-distributors-by-categories?${locationType}=${locationValue}&year=${apiYear}&month=${apiMonth}&interval=monthly`;
          console.log(apiUrl);
