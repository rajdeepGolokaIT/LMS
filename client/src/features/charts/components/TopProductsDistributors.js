    ...
    const fetchTopSellingProducts = async () => {
      try {
        ...
        if (selectedInterval === "Yearly") {
          apiUrl = `${BASE_URL}/api/v1/invoice/top-distributors-by-region?${locationType}=${locationValue}&year=${selectedYear}&interval=annually`;
          console.log(apiUrl);
          ...
          apiUrl = `${BASE_URL}/api/v1/invoice/top-distributors-by-region?${locationType}=${locationValue}&year=${apiYear}&month=${apiMonth}&interval=monthly`;
          console.log(apiUrl);
          ...
          apiUrl = `${BASE_URL}/api/v1/invoice/top-distributors-by-region?${locationType}=${locationValue}&customFromDate=${fromDate}&customToDate=${toDate}&interval=${intervalParam}`;
          console.log(apiUrl);
