...
const LeastProductsDistributors = () => {
    ...
    const fetchTopSellingProducts = async () => {
      try {
        ...
        if (selectedInterval === "Yearly") {
          ...
          apiUrl = `https://www.celltone.iskconbmv.org:8444/SalesAnalysisSystem-0.0.1-SNAPSHOT/api/v1/invoice/least-distributors-by-region?${locationType}=${locationValue}&year=${selectedYear}&month=${monthParam}&interval=monthly`;
          console.log(apiUrl);
  ...
  return (
    <>
    <TitleCard
       title="Least Sold Product By Distributor"
       topMargin="mt-2"
       TopSideButtons1={
         <>
           <select
...
export default LeastProductsDistributors