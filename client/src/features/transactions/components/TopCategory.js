    ...
    const fetchTopSellingProducts = async () => {
      try {
        ...
        if (selectedInterval === "Yearly") {
          ...
          apiUrl = `https://www.celltone.iskconbmv.org:8444/SalesAnalysisSystem-0.0.1-SNAPSHOT/api/v1/invoices/most-selling-products-by-category?${locationType}=${locationValue}&year=${selectedYear}&month=${monthParam}&interval=monthly`;
          console.log(apiUrl);
