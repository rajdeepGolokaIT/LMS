...
const LeastCategory = () => {
    ...
    const fetchTopSellingProducts = async () => {
      try {
        ...
        if (selectedInterval === "Yearly") {
          apiUrl = `${BASE_URL}/api/v1/invoices/least-selling-products-by-category?${locationType}=${locationValue}&year=${selectedYear}&interval=annually`;
          console.log(apiUrl);
          ...
          apiUrl = `${BASE_URL}/api/v1/invoices/least-selling-products-by-category?${locationType}=${locationValue}&year=${apiYear}&month=${apiMonth}&interval=monthly`;
          console.log(apiUrl);
          ...
          apiUrl = `${BASE_URL}/api/v1/invoices/least-selling-products-by-category?${locationType}=${locationValue}&customFromDate=${fromDate}&customToDate=${toDate}&interval=${intervalParam}`;
          console.log(apiUrl);
  ...
  //   };
    ...
    const downloadPDF = () => {
      ...
      const title = "Least Sold Category";
      const fontSize = 14;
      const textWidth =
      ...
      pdf.save("Least Sold Category.pdf");
    };
